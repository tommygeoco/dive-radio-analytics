...
| | Show health (`health.mjs`, formula `health-v5`, prompt v7) | Episode health (`ratings.mjs`, algorithm `health21-v2`) + launch word (`baselines.launchReadFor`) |
|---|---|---|
