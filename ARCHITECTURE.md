...
| `alerts-state.json` | last-seen values used to detect a change | alerts | updated after a confirmed publish | day-over-day diff; committed with the next successful data release |
