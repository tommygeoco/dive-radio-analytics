...
- [ ] Push main, update the dedicated publisher, deploy, and prove all public artifacts.
...
Implementation and release validation in progress. Actual E8 topic markers remain dependent on YouTube returning the retention curve.
...
3. [in progress] Run the full release gate, push main, deploy from the dedicated publisher, and inspect live E8 and E4.
...
- [ ] Full release gate, production byte parity, browser tooltip checks, and clean main pass.
