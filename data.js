window.DIVE_DATA = {
 "generatedAt": "2026-08-23T20:22:38.880Z",
 "dests": [
  {
   "key": "yt:joindiveclub",
   "label": "YT Dive Club",
 ...
 "episodes": [
  {
   ...
   "watch": {
    ...
    "updatedAt": "2026-08-23T20:20:35.795Z",
    "shape": {
     "openStart": 67.4,
     "openFloor": 11.8,
     "recoveryPeak": 28.6,
  ...
  },
  {
   ...
   "metrics": {
    ...
    "anomaly": "more than double what a typical episode gets (4,206 X plays vs a typical 1,801; 19,641 X reach vs a typical 6,116) — treat as promo-driven outlier, not topic signal"
   },
   "ep": 3,
   "live": {
    "peak": 53,
 ...
 "insights": [
  {
   "id": "opening-cliff",
   "text": "Viewers vanish in the first minutes: E1 had 67.4 of every 100 watching near the start but only 11.8 left at the 2% mark; E2 kept 14.9. The biggest exit came roughly 7 minutes into E1, when 8 of every 100 left during the 'still figuring it out' preamble.",
   "recommendation": "Test a cold open this week: lead with the strongest demo or guest moment in the first minute, and push show setup, housekeeping, and 'what we're working on' talk to later in the episode. Compare the 2% mark hold against E2's 14.9 next report.",
   "category": "content"
  },
  {
   "id": "show-work-earlier",
   "text": "Extra viewers arrive when work is shown on screen. In E6, still in its first weeks, 2.9 extra viewers of every 100 tuned in about halfway through, near 47 minutes, during the live logo review; E5 gained 2.4 extra around 53 minutes showing HTML mockups.",
   "recommendation": "Schedule one hands-on show-and-tell segment in the first third of this week's episode and tease it in the opening line. Test whether moving the screen-share moment earlier lifts the early hold instead of rewarding only the viewers who stay an hour.",
   "category": "content"
  },
  {
   "id": "channel-gap-e1-clue",
   "text": "Dive Club leads overall: 5144 views, 17 subscribers, 3.3 per 1,000, 11.3 average share watched, against DesignerTom's 3707 views, 8 subscribers, 2.2 per 1,000, 9.6 watched. Yet on finished E1, DesignerTom converted at 13.3 per 1,000 to Dive Club's 5.7.",
   "recommendation": "Pull up E1's DesignerTom title, thumbnail, and description this week and reuse that framing on both channels for the next upload. DesignerTom has gained 0 subscribers on the last three episodes, so treat E1 as the working template until a test says otherwise.",
   "category": "distribution"
  },
  {
   "id": "dead-discovery-surfaces",
   "text": "Existing subscribers supply 54.8 of every 100 YouTube views (4858 views). Discovery surfaces bring almost nothing: search 433 views, playlists 61, end screens 7, Shorts just 2.",
   "recommendation": "This week, cut two short vertical clips from the best episode moments and publish them as Shorts linking the full video, add an end screen to every upload pointing at the latest episode, and put all episodes into one playlist on each channel.",
   "category": "distribution"
  },
  {
   "id": "x-audience-untapped",
   "text": "More of the show is watched on X than on YouTube: 12,755 X broadcast plays against 9,816 YouTube views, 56.5 of every 100 total plays — but only the YouTube side builds a subscriber base the hosts own.",
   "recommendation": "Pin the YouTube link as the first reply on every X broadcast this week and tell X viewers on air, by name, where the full archive and subscribe button live. Test whether YouTube views from outside links climb above the current 511.",
   "category": "promotion"
  },
  {
   "id": "subscriber-conversion-slide",
   "text": "Among finished episodes, conversion is sliding: E1 earned 8.9 subscribers per 1,000 views across both channels, E2 fell to 2.9, and E3 landed at 0 on both channels.",
   "recommendation": "Script one direct on-air subscribe ask tied to a concrete payoff — next week's guest or segment — and deliver it right after the strongest demo, not in the outro. Repeat it once mid-show and check whether the E3-style zero repeats.",
   "category": "audience"
  }
 ],
 "insightsStale": [],
 ...
 "health": {
  ...
  "ageDays": 0,
  "withheld": false,
  "formulaVersion": "health-v2",
  "dataThrough": "2026-08-23T18:24:08.560Z",
  "score": 51,
  "readState": "early",
  "headline": "Warm feedback and steady live turnout, but new viewers rarely subscribe right now.",
  "checks": [
   {
    "key": "growth",
    "score": null,
    ...
    "measures": [
     ...
     },
     {
      ...
      "typical": null,
      "sample": 1,
      "reason": "Only 0 prior episodes were tracked this early; at least three are required.",
      "ageBasis": null,
      "note": null,
      "episodeRead": null
     }
  ...
  "pros": [
   {
    "text": "The latest show peaked at 71 live viewers, a touch above what prior shows usually draw.",
    "factId": "latest-live-peak"
   },
   {
    "text": "Viewers watched 12.9% of the latest YouTube episode on average, a slightly better hold than usual, though still early.",
    "factId": "latest-watch-percent"
   }
  ],
  "cons": [
   {
    "text": "The latest episode added 1.6 subscribers for each thousand YouTube views, below the usual pace, though still early.",
    "factId": "latest-subscriber-rate"
   },
   {
    "text": "The latest episode drew 27.6 engagements for each thousand YouTube views, under the usual pull, though still early.",
