window.DIVE_DATA = {
 "generatedAt": "2026-08-30T14:02:51.120Z",
 "dests": [
  {
   "key": "yt:joindiveclub",
   "label": "YT Dive Club",
 ...
 "episodes": [
  {
   ...
   "watch": {
    ...
    "updatedAt": "2026-08-30T14:01:12.542Z",
    "shape": {
     "openStart": 67.1,
     "openFloor": 11.9,
     "recoveryPeak": 28.4,
  ...
  },
  {
   ...
   "metrics": {
    ...
    "anomaly": "more than double what a typical episode gets (4,228 X plays vs a typical 1,851; 19,596 X reach vs a typical 5,041) — treat as promo-driven outlier, not topic signal"
   },
   "ep": 3,
   "live": {
    "peak": 53,
  ...
  },
  {
   ...
   "metrics": {
    ...
    "flatlineWeek": null,
    "engagementPer1k": 9,
    "anomaly": "more than double what a typical episode gets (4,226 YT views vs a typical 1,940; 12,707 X reach vs a typical 6,133) — treat as promo-driven outlier, not topic signal"
   },
   "ep": 7,
   "live": {
    "peak": 72,
 ...
 "insights": [
  {
   ...
   "text": "Every episode loses most viewers in the opening minutes: E1 opens with 67.1 of every 100 watching near the start but only 11.9 remain at the 2% mark, and E1's biggest exit came around 6% of the way in, about 7 minutes, losing 7.9 of every 100.",
   "recommendation": "Rework this week's open as a test: lead with the strongest clip or demo inside the first minute, push intros and housekeeping to after the first segment, and check whether the share still watching at the 2% mark rises on the next episode.",
   "category": "content"
  },
  {
   "id": "repeat-episode-one-playbook",
   "text": "Among finished episodes, E1 won subscribers best at 8.9 per 1,000 views blended — 13.2 on DesignerTom and 5.6 on Dive Club — while E3 earned 0 new subscribers on both channels.",
   "recommendation": "List what E1 did differently — guest, topic, title, on-air subscribe ask — pick the two most likely drivers, and deliberately repeat them in this week's episode as a test, then compare subscriber gain against E3's format.",
   "category": "content"
  },
  {
   "id": "tighten-long-demos",
   "text": "E4 lost 6.1 of every 100 viewers around two fifths of the way in, roughly 48 minutes into the live recording, during a long back-and-forth demo (\"I'm just rambling at this point\"), and E4 had the weakest end hold among finished episodes at 6.3 still watching.",
   "recommendation": "Time-box demos this week: set a fixed segment length, tease what comes next before starting the demo, and cut when momentum dips — then compare the middle-half hold and end hold against E4.",
   "category": "content"
  },
  {
   "id": "dive-club-converts-better",
   "text": "Dive Club turns viewers into subscribers much better than DesignerTom: 3 subscribers per 1,000 views and 12.4 average share watched on 6,410 views, versus 1.6 per 1,000 and 9.6 share watched on 4,852 views — 19 subscribers gained versus 8.",
   "recommendation": "Make Dive Club the primary home for the full episode this week and give DesignerTom a different job: post short clips there pointing viewers to the Dive Club stream, then compare each channel's subscriber gain after the episode.",
   "category": "distribution"
  },
  {
   "id": "convert-x-viewers",
   "text": "Just over half of all watching happens on X — 15,146 plays there versus 14,499 YouTube views, 51.1 of every 100 total — yet subscriber growth only happens on YouTube, where those X viewers never land.",
   "recommendation": "Pin the YouTube link in every X broadcast, say it aloud twice per show, and post one X-only clip mid-week that points to the YouTube upload; check next week whether YouTube views from outside links move.",
   "category": "distribution"
  },
  {
   "id": "discovery-surfaces-idle",
   "text": "60.2 of every 100 YouTube views come from existing subscribers (6,789 views). Search brings 4.6 of 100, notifications 2.7, end screens just 8 views total, and Shorts just 2 — the surfaces that reach new people bring almost nothing.",
   "recommendation": "This week, cut three Shorts from the episode's best moments and add an end screen on every past upload pointing to the newest episode; check in seven days whether Shorts and end screen views move off 2 and 8.",
   "category": "promotion"
  },
  {
   "id": "chat-energy-fading",
   "text": "The live room is steady but participation is fading: peak live viewers went from 90 in E1 to 72 in E7, while chat messages fell from 383 to 92 over the same run.",
   "recommendation": "Schedule two named chat moments this week — a specific question in the first segment and a poll mid-show — and read answers on air; see if chat messages climb back over 100 next episode.",
   "category": "audience"
  }
 ],
 "insightsStale": [],
