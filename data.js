window.DIVE_DATA = {
 "generatedAt": "2026-09-01T22:49:38.519Z",
 "dests": [
  {
   "key": "yt:joindiveclub",
   "label": "YT Dive Club",
 ...
 "episodes": [
  {
   ...
   "watch": {
    ...
    "updatedAt": "2026-09-01T22:48:45.698Z",
    "shape": {
     "openStart": 67.1,
     "openFloor": 12,
     "recoveryPeak": 28.5,
  ...
  },
  {
   ...
   "metrics": {
    ...
    "flatlineWeek": null,
    "engagementPer1k": 8.7,
    "anomaly": "more than double what a typical episode gets (4,923 YT views vs a typical 1,600; 13,333 X reach vs a typical 5,496) — treat as promo-driven outlier, not topic signal"
   },
   "ep": 7,
   "live": {
    "peak": 72,
 ...
 "insights": [
  {
   ...
   "text": "Reach is fragile: the share of announced followers who actually play an episode sits at 13 against a typical 31.4, and it is softening across the last 5 clean episodes.",
   "recommendation": "Rework this week's episode announcement: post it the morning of the show with the exact start time, pin the play link on both channels, and send one reminder an hour before going live. Compare the play rate against the last announce.",
   "category": "distribution",
   "rank": 1,
   "serves": "reachEfficiency"
  },
  {
   "id": "tighten-early-minutes",
   "text": "Audience quality is fragile: first-week engagement reads 43 against a typical 70, and share watched, carried from an older finished episode, is 8.9 against a typical 10.7 and softening.",
   "recommendation": "Test a tighter first act: on the newest episode roughly 4.1 of every 100 viewers left about a fifth of the way in, near the 18 minute mark during nomination banter. Cap that segment, move the headline demo earlier, and check if the exit shrinks.",
   "category": "content",
   "rank": 2,
  ...
  {
   "id": "revive-chat",
   "text": "Chat is thinning: chatters per 100 read 55.6 against a typical 82.4 and messages per hour 50.2 against 85.3. The newest episode drew 92 messages from 40 chatters; E1 drew 383 from 104.",
   "recommendation": "Plan three named chat moments into this week's run of show: a live vote, a direct question to chatters by name, and a show-and-tell call for links. Assign one host to read and answer chat aloud so replies land within the segment.",
   "category": "audience",
   "rank": 3,
   "serves": "participation"
  },
  {
   "id": "close-channel-gap",
   "text": "Dive Club converts and holds better overall: 2.6 subscribers per 1,000 views and 12 share watched, against DesignerTom's 1.4 and 9.8. Yet on finished E1, DesignerTom hit 13.2 per 1,000 — the pattern is not fixed.",
   "recommendation": "Test E1-style packaging on DesignerTom this week: mirror its title angle and a spoken subscribe ask at the rebound point. If DesignerTom stays flat again, shift the premiere slot and first push to Dive Club.",
   "category": "promotion",
   "rank": 4,
   "serves": "conversion"
  },
  {
   ...
   "text": "Live turnout is slipping even as the room holds: 727 people watched the newest show live against a typical 1125, while average concurrents read 56 against a typical 49.",
   "recommendation": "Lean on X, where 50.2 of all watching happens: post the show time there the night before and again at start, and tease one specific segment. Keep the same weekly slot for the next episodes and watch whether live viewers recover.",
   "category": "promotion",
   "rank": 5,
   "serves": "livePull"
  },
  {
   "id": "pace-rank",
   "text": "Steal These AI Design Patterns + Live Call-Ins has 7,337 total views 5.2 days in — on YouTube it's pacing #1 of 4 at this age, 208% ahead of the typical episode — a promo-driven lift so far, shown here and not scored in show health.",
   "recommendation": "Its first days ran on promotion. Watch whether it keeps pace after the push fades before repeating the format.",
