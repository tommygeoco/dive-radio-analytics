window.DIVE_DATA = {
 "generatedAt": "2026-08-22T23:56:19.802Z",
 "dests": [
  {
   "key": "yt:joindiveclub",
   "label": "YT Dive Club",
 ...
 "episodes": [
  ...
  },
  {
   ...
   "rating": {
    ...
    "provisional": true,
    "computedAt": "2026-08-22T23:56:18.091Z",
    "frozenAt": null
   }
  }
 ],
 "insights": [
  ...
  },
  {
   ...
   "caveat": "Per-episode X share ranges 46% (E1 (Bumpy Takeoff)) to 72% (E3 (Mixed Media Workflows)); only episodes with complete X play counts are included (6).",
   "chartState": {
    "xMode": "weeks",
    "yMode": "cumulative",
    "dests": [
  ...
  {
   "id": "host-plays-split",
   "text": "People actually sit in @ridd_design's room: 62% of broadcast watching happens there (5,303 ridd vs 3,201 tom).",
  ...
  {
   "id": "reach-conversion",
   "text": "Announce hooks close very differently: E4 (Backyard Designers behind-the-scenes) turned 41 of every 100 announce impressions into actual plays; E5 (Goodbye) managed only 23.",
   ...
   "caveat": "X broadcast plays for every 100 announce impressions; episodes at least 7 days old, with promo outliers left out, sample of 4.",
   "chartState": {
    "xMode": "weeks",
    "yMode": "cumulative",
    "dests": [
  ...
  },
  {
   ...
   "caveat": "YouTube only; episodes at least 7 days old because likes and comments per 1,000 views change with age, sample of 5.",
   "chartState": {
    "xMode": "weeks",
    "yMode": "cumulative",
    "dests": [
  ...
  },
  {
   ...
   "caveat": "Peak concurrents from Restream across all simulcast destinations; compared with the typical result from 5 prior episodes.",
   "chartState": {
    "view": "live"
   },
   "category": "audience"
  ...
  {
   "id": "partial-history",
   "text": "E3, E4 and E5 were registered late — their early weekly history doesn't exist. Totals are right; first-week growth comparisons aren't.",
